...
ggplot(ff, aes(year)) +
  ...
  labs(x = "Year",
       y = "Source fraction",
       title = "Source of carbon in the atmosphere from fossil fuel over time")
```
...
## TO DO color by source_fraction, find alternate to pairs()
# This currently does not work! Color by number/factor is throwing errors

ggpairs(single,
        aes(color = cut(source_fraction, 6), group = 1),
        columns = 9:12,
        upper = list(na= "na"))
