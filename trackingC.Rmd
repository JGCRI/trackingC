...
names(ssp_labels) <- c("ssp119", "ssp126", "ssp245", "ssp370", "ssp434", "ssp460", "ssp534-over", "ssp585")
...
# ...and plot!
relimp_out %>%
  mutate(param = factor(param, levels = rev(names(name_vector)))) %>%
