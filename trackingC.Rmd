...
ggplot(plot_r, aes(year, group = run_number)) +
  geom_ribbon(aes(ymin = minimum, ymax = maximum), alpha = 0.3) +
  geom_ribbon(aes(ymin = med - sdev, ymax = med + sdev), alpha = 0.2) +
  geom_line(aes(y = med)) +
  geom_line(data = ea, aes(y = frac, group = run_number), color = "blue")
