...
# Read in data files
runlist <- read.csv("./data_files/runlist.csv")
model_output <- read.csv("./data_files/model_output.csv")
trk_output <- read.csv("./data_files/trk_output.csv")
...
hector_co2_71 <- model_output_filtered %>%
  filter(variable == "Ca",
         year == 1971) %>%
  select(run_number, year, value)

hector_co2_21 <- model_output_filtered %>%
  filter(variable == "Ca",
         year == 2021) %>%
  select(run_number, year, value)
