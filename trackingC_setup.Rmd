...
generate_params <- function(run_numbers){
  ...
  tibble(
    ...
    "BETA" = rnorm(runs, mean = 0.54, sd = 0.1),
...
### Move to setup, write out destination file and tracking file
...
fwrite(dest_output, "./output_files/dest_output.csv", row.names = FALSE)
```
